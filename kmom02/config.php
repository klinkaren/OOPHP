...
$zeus['footer'] = <<<EOD
<footer><span class='sitefooter'> <a href='https://github.com/klinkaren/OOPHP'>Projektet på github</a> | <a href='http://validator.w3.org/unicorn/check?ucn_uri=referer&amp;ucn_task=conformance'>Unicorn</a></span></footer>
EOD;
...
$zeus['navbar'] = array(
  ...
  'items' => array(
    ...
    'dice100'      => array('text'=>'Tärningsspelet',      'url'=>'dice100.php',      'title' => 'Spela tärningsspelet Dice 100'),
    'manadens_babe'=> array('text'=>'Månadens babe',       'url'=>'manadens_babe.php','title' => 'Visa kalendern månadens babe'),
